...
export default function LigusterLandingPage() {
  ...
  return (
    <div className="font-sans text-gray-800 bg-gray-50 min-h-screen pb-0">
      ...
      <nav className="relative md:absolute inset-x-0 top-0 z-20 border-b border-white/10 bg-[#071a2f]/35 backdrop-blur-sm">
      ...
      <section className="bg-liguster-gradient relative min-h-[95vh] flex items-start md:items-center overflow-hidden">
        <div className="grid content-shell py-8 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 relative z-10 pt-10 sm:pt-12 md:pt-0">
